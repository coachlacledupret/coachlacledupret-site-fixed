...
const LeadMagnet = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Rediriger vers la page du guide après un court délai
      setTimeout(() => {
        // Pour l'instant, on redirige vers la page de contact
          ...
          >
            <div className="relative w-full max-w-md aspect-[3/4] rounded-lg overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Couverture du guide - Les 10 erreurs à éviter pour votre prêt immobilier"
                fill
                ...
                <div className="pt-4">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="w-full bg-gradient-to-r from-[#1f4e79] to-[#2e8b57] text-white py-4 px-6 rounded-lg font-semibold text-lg hover:shadow-lg transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
                    >
                      {isLoading ? (
                        <>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
                    <div className="space-y-3">
                      ...
                      <p className="text-blue-700 text-sm">
                        Vous allez être redirigé vers votre guide dans quelques secondes.
                      </p>
